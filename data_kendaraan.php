...
$col = array();
$col["title"] = "Tahun"; // caption of column
$col["name"] = "tahun"; // nama harus sama yaaaa ^_^ buat semua $col[name]
$col["editable"] = true; 
$col["search"] = true; 
$col["width"] = "130";
$cols[] = $col;	
...
$col = array();
$col["title"] = "Mobil Penumpang";
$col["name"] = "mobil_penumpang";
$col["editable"] = true; 
$col["search"] = true; 
$col["width"] = "130";
$cols[] = $col;
...
$col = array();
$col["title"] = "Sepeda Motor"; 
$col["name"] = "sepeda_motor"; 
$col["editable"] = true; 
$col["search"] = true; 
$col["width"] = "130";
$cols[] = $col;	
...
$grid["caption"] = "Data Kendaraan"; // caption of grid
...
$g->select_command = "SELECT * from data_kendaraan";

// this db table will be used for add,edit,delete
$g->table = "data_kendaraan";

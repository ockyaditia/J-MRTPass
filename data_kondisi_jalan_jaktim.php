...
$grid["caption"] = "Data Kondisi Jalan Jakarta Timur"; // caption of grid
...
$g->select_command = "SELECT * from data_kondisi_jalan_jaktim";

// this db table will be used for add,edit,delete
$g->table = "data_kondisi_jalan_jaktim";
...
<html>
	...
	<body style = "background-image:url(images/jayaraya2.jpg); background-attachment: fixed; background-size: 100%; background-repeat: no-repeat;">
		...
		<div><a href = "insert_data_kondisi_jalan_jaktim.php"><img src = "images/file_add.png" width = "50" style = "position:absolute; margin-top:200px; margin-left:40px;"></a></div>

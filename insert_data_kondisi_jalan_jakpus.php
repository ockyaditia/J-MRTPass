...
<html>
	...
	<body style = "background-image:url(images/jayaraya2.jpg); background-attachment: fixed; background-size: 100%; background-repeat: no-repeat;">
		...
		<div style = "background-color: rgba(25, 181, 254, 0.9); border: 5px solid white; padding: 20px;">
			<form action="config/insert_data_kondisi_jalan_jakpus.php" method="post">
			
				<h2 style = "color: gold; font-weight:bolder;">Data Kondisi Jalan Jakarta Pusat</h2>
				
				<br>

				<div class="form-group">
					<input type="text" id="contact_name" name="jakarta" class="form-control" placeholder="Nama Jalan Di Jakarta Pusat" required />
				</div>
				<div class="form-group">
			...
			?>
						<center><h3 style = "color: gold; font-weight:bolder;">Data Kondisi Jalan Jakarta Pusat Berhasil Di Tambah</h3>
						<h3><a href = "data_kondisi_jalan_jakpus.php">Lihat Data</a></h3>
						</center>
			<?php
					}
				}

...
$col = array();
$col["title"] = "Jakarta Timur"; // caption of column
$col["name"] = "jakarta_timur"; // nama harus sama yaaaa ^_^ buat semua $col[name]
$col["editable"] = true; 
$col["search"] = true; 
$col["width"] = "130";
$cols[] = $col;	
...
$col = array();
$col["title"] = "Jakarta Selatan";
$col["name"] = "jakarta_selatan";
$col["editable"] = true; 
$col["search"] = true; 
$col["width"] = "130";
$cols[] = $col;
...
$col = array();
$col["title"] = "Jakarta Utara"; 
$col["name"] = "jakarta_utara"; 
$col["editable"] = true; 
$col["search"] = true; 
$col["width"] = "130";
$cols[] = $col;		
...
$col = array();
$col["title"] = "Jakarta Pusat";
$col["name"] = "jakarta_pusat";
$col["editable"] = true; 
$col["search"] = true; 
$col["width"] = "130"; 
$cols[] = $col;
...
$col = array();
$col["title"] = "Jakarta Barat"; 
$col["name"] = "jakarta_barat"; 
$col["editable"] = true; 
$col["search"] = true; 
$col["width"] = "130";
$cols[] = $col;		
...
$grid["caption"] = "Data Kemacetan"; // caption of grid
...
$g->select_command = "SELECT * from data_kemacetan";

// this db table will be used for add,edit,delete
$g->table = "data_kemacetan";
...
<html>
	...
	<body style = "background-image:url(images/jayaraya2.jpg); background-attachment: fixed; background-size: 100%; background-repeat: no-repeat;">
		...
		<div><a href = "insert_data_kendaraan.php"><img src = "images/file_add.png" width = "50" style = "position:absolute; margin-top:200px; margin-left:40px;"></a></div>

...
$col = array();
$col["title"] = "Jakarta Utara"; // caption of column
$col["name"] = "jakarta_utara"; // nama harus sama yaaaa ^_^ buat semua $col[name]
$col["editable"] = true; 
$col["search"] = true; 
$col["width"] = "130";
$cols[] = $col;	
...
$grid["caption"] = "Data Kondisi Jalan Jakarta Utara"; // caption of grid
...
$g->select_command = "SELECT * from data_kondisi_jalan_jakut";

// this db table will be used for add,edit,delete
$g->table = "data_kondisi_jalan_jakut";
...
<html>
	...
	<body style = "background-image:url(images/jayaraya2.jpg); background-attachment: fixed; background-size: 100%; background-repeat: no-repeat;">
		...
		<div><a href = "insert_data_kondisi_jalan_jakut.php"><img src = "images/file_add.png" width = "50" style = "position:absolute; margin-top:200px; margin-left:40px;"></a></div>
